...
print("销量异常值检查")
print("负销量数量：",(data["num_of_sales"]<0).sum(),'\n')

print("评分异常值检查")
print("rolling_stone_critic异常数量：",((data["rolling_stone_critic"]<0)|(data["rolling_stone_critic"]>5)).sum())
print("mtv_critic异常数量：",((data["mtv_critic"]<0)|(data["mtv_critic"]>5)).sum())
print("music_maniac_critic异常数量：",((data["music_maniac_critic"]<0)|(data["music_maniac_critic"]>5)).sum())
